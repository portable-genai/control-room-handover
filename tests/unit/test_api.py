...
def test_handover_uses_the_verified_principal_as_actor(api_client: TestClient) -> None:
    ...
    assert body["total_queue_depth"] == 412
    # Rule R8: the handover was routed, not merely flagged (see test_review_routing.py).
