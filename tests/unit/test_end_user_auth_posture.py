...
read
    ...
    bind_profile == local AND profile chosen AND CONTROLROOM_S2S_TOKEN unset
...
from control_room_handover.adapters.local.identity import (
    LocalIdentityAdapter,
)
from control_room_handover.adapters.onprem.identity import (
