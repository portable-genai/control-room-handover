# Control Room Handover (F5) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CONTROLROOM_PROFILE=gcp \
    CONTROLROOM_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn control_room_handover.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
